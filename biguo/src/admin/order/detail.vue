<template>
  <div class="detail">
    <el-button type="success" @click="$emit('detail', '');" size="small" style="margin-bottom: 0.2rem;">返回</el-button>
    <el-row :gutter="20">
      <el-col :span="12">
        <div class="left">
          <h3>分期信息</h3>
  ...
  export default {
    ...
    methods: {
      bigImg(n){
        ...
        this.big = n==0?this.data.idCardFrontImg:(n==2?this.data.receiptImg:this.data.idCardBackImg)
      },
      pass(status){
        if(status==2){
