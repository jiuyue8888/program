    ...
    <div class="steps">
      ...
      <div class="p1" v-show="active==0">
        ...
        <div class="photo photo1">
          ...
          <van-uploader :after-read="afterRead1" preview-size="5.7rem"/>
          <p>上传身份证正面</p>
        </div>
        <div class="photo photo2">
          <img v-show="formData.idCardBackImg!=''" :src="formData.idCardBackImg" />
          <van-uploader :after-read="afterRead2" preview-size="5.7rem"/>
          <p>上传身份证背面</p>
        </div>
        <div class="photo photo3">
          <img v-show="formData.receiptImg!=''" :src="formData.receiptImg" />
          <van-uploader :after-read="afterRead3" preview-size="5.7rem"/>
          <p>上传首付收据</p>
        </div>
      </div>
      ...
      <div class="p3" v-show="active==2">
        ...
        <div class="border"></div>
        <van-field v-model="formData.cardOwnerName" disabled label="持卡人" placeholder="请填写持卡人" @blur="check" />
        ...
        <strong>
          <input type="checkbox" @change="agreeHandle" :checked="inputChecked" />我已阅读并同意<em @click="openNewPage">《授权扣款协议书》</em>
        </strong>
      ...
      <div class="p4" v-show="active==3">
        <div class="p4Body">
          ...
          <van-cell title="每期应还" :value="Math.ceil(formData.amount/formData.stages*100)/100" />
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      submit() {
        ...
        //cardOwnerName
        Object.assign(this.formData, {
          cardOwnerName: this.formData.name
        })
        if (this.active == 2) {
