...
export default {
  ...
  methods: {
    ...
    //导出订单
    excel(){
      window.location.href = `https://m.doujinfq.com/product/web/inner/api/exported?orderStatus=${this.pageData.orderStatus}&orderCode=${this.pageData.orderCode}&endDate=${this.pageData.endDate}&startDate=${this.pageData.startDate}&sessionCode=${window.localStorage.getItem('sessionCode')}`
